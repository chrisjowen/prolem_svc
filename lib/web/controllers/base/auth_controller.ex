# defmodule ProblemService.AuthController do
#   use ProblemService.Web, :controller
#   plug Ueberauth

#   alias ProblemService.UserRepo
#   @completion_url Application.get_env(:problem_service, ProblemService.AuthController)[:completion_url]
...
#          {:ok, token, _claims} <- ProblemService.Guardian.encode_and_sign(user) do
