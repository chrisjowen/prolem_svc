# defmodule Openai.SectorDescribe do
...
#                %{
#                  role: "user",
#                  content: "The sector to describe is: #{sector}"
#                }
#              ]
#            ) do
...
#   defp format(),
#     do: """
#     You should return valid HTML with the following tags h1,h2,h3,ul,ol,li and p.
