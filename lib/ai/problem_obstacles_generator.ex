defmodule Ai.ProblemObstaclesGenerator do
  ...
  def goal() do
    ...
    Each obstacle should be returned in the form of JSON and you should attempt to give solution hints to overcoming the obsicle.
    """
  end
